...
img_project1 = Image.open("https://www.techjunkie.com/svg-animation-examples/")
...
# --- Projects Section ---
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Scalable Vector Graphics (SVG)")
            st.write(
                """ 
                This is a loptop showing its feature of a system made in Html, Css and Java Script. 
                """
                """ 
                This web app is finally finish and ready to deploy. 
                """
                """
                this webpage is a sample in my project. 
                """
            )
    ...
    with st.container():
        ...
        with left_column:
            ...
            st.write("""
                ...
                - I am going to be a best programmer soon.
                - Achieve that goal.
            """)
